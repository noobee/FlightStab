...
enum WING_MODE {WING_USE_DIPSW=1, 
  WING_RUD_ELE_SINGLE_AIL, WING_DELTA_SINGLE_AIL, WING_VTAIL_SINGLE_AIL, 
...
#define WING_MODE_TO_DUAL_AIL {false, false, false, false, false, true, true, true} // must be consistent with enum WING_MODE
